...
const ProjectsPage = () => {
  ...
  const queryParams = {
    ...
    ...(showMineOnly ? { ownerId: currentUser?.id } : {}),
  };
  const {
    data,
    fetchNextPage,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      {/* Project content area — only this part reacts to loading/error */}
      <div className={`transition-opacity ${isFetching && !isFetchingNextPage ? 'opacity-60' : 'opacity-100'}`}>
        {isLoading && (
        ...
        {!isLoading && !error && allProjects.length === 0 && (
          <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              {debouncedSearchQuery || statusFilter !== "ALL" || showMineOnly
